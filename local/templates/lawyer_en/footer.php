<?php if (!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED !== true) die(); ?>
    ...
    <footer class="footer">
      <div class="footer__container">
        ...
        <div class="footer-bottom">
          <!-- <a href="#contacts" class="address"><//?=$GLOBALS['ADDRESS_ALL_EN']?></a> -->
          <a href="upload/politic.pdf" class="politics" target="_blank">
            <?$APPLICATION->IncludeComponent(
              ...
              Array(
                ...
                "EDIT_TEMPLATE" => "",
                "PATH" => "/local/include/en/politics/politics.php"
              )
            );?>  
          </a>
        </div>
  ...
  <?$APPLICATION->IncludeComponent(
    ...
    Array(
      ...
      "AREA_FILE_SUFFIX" => "inc",
      "EDIT_TEMPLATE" => "",
      "PATH" => "/local/include/en/popup/popup-callback.php"
    )
  );?>  
  <?$APPLICATION->IncludeComponent(
    "bitrix:main.include",
    ...
    Array(
      ...
      "AREA_FILE_SUFFIX" => "inc",
      "EDIT_TEMPLATE" => "",
      "PATH" => "/local/include/en/popup/popup-sucsess.php"
    )
  );?> 
</body>
